...
import { TProfile, TPhotos } from '../../../types/types'
...
const ProfileInfo: React.FC<Props> = ({ profile, lookingForAJob, lookingForAJobDescription, photos, status, updateStatus, isOwner }) => {
