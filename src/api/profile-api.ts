...
import { TProfile } from '@typings/types'
...
export const profileAPI = {
  getProfile(userId: number) {
    return instance.get<TProfile>(`profile/${userId}`).then((res) => res.data)
  },
  ...
  saveProfile(profile: TProfile) {
    return instance.put<TServerResponse>(`profile`, profile).then((res) => res.data)
  },
}
